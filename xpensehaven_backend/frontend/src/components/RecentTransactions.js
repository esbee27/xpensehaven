...
import { MdOutlineSwapHoriz } from "react-icons/md"; // Import Wallet Icon
  ...
  return (
    <div className="recent-transactions">
      ...
      <h3 className="recent-transactions-header">
        <MdOutlineSwapHoriz  className="wallet-icon" />
      ...
      {recentTransactions.length > 0 ? (
        ...
        <p className="no-transactions">Nothing to show here😢...</p>
      )}
